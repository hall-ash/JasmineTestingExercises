...
// expects the paymentId and removes the associated payment 
// from the payment table and allPayments
// and updates the server table and the summary table 
const removePaymentFromPaymentTable = (paymentId) => {
  document.querySelector(`#${paymentId}`).remove();
